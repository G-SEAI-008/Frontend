...
describe('cart Badge', () => {
  ...
  test('should render with empty cart', () => {
  ...
  test('should render with multiple items with mixed quantities', () => {
    const items = [
      {
        id: 1,
        name: 'Product 1',
  ...
  test('should format currency correctly in German locale', () => {
    const items = [
      {
        id: 1,
  ...
  test('should be accessible with aria-label', () => {
    renderCartBadgeWithItems([]);
    const badge = screen.getByLabelText('cart-count');
    expect(badge).toBeInTheDocument();
  ...
  test('should handle edge case with zero price items', () => {
    const items = [
      {
        id: 1,
        name: 'Free Product',
