 ...
 *
 * @param {string} pizzaSize - Size of the pizza ('small', 'medium', 'large')
 * @param {string[]} toppings - Array of toppings
 * @param {number} customerAge - Age of the customer
 * @returns {{ isValid: boolean; error?: string }} Object with isValid boolean and error message if
 *   invalid
 */
