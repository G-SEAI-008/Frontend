 ...
 *
 * @param {boolean} includeTitle - Whether to include titles like "Captain" or "Doctor"
 * @returns {string} A randomly generated superhero name
 */
export function generateSuperheroName(includeTitle = false): string {
  const adjectives = [
    'Mighty',
    'Swift',
    'Brave',
